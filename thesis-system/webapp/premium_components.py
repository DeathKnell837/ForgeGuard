...
<text x="100" y="115" text-anchor="middle" fill="{verdict_color}" font-family="'JetBrains Mono', 'IBM Plex Mono', monospace" font-size="9" font-weight="600" letter-spacing="2.5" opacity="0.85">{verdict_label}</text>
</svg>
</div>"""
